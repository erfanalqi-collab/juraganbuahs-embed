(function(){
  ...
  function openDetail(p){
    ...
    modalContent.innerHTML+=`<a target="_blank" href="https://wa.me/6281359655276?text=Halo,%20saya%20mau%20${encodeURIComponent(p.name)}" style="display:inline-block;margin-top:10px;background:#25D366;color:#fff;padding:10px 14px;border-radius:8px;text-decoration:none">💬 Pesan via WA</a>`;
